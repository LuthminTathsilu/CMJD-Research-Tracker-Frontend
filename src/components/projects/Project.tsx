...
import { getAllProjectsData, deleteProjectData, updateProjectData, addProjectData, updateProjectStatusData, ProjectModel} from "../../service/ProjectService";
...
const formatDate = (isoString: string | null | undefined): string => {
    ...
    try {
        ...
        // Fallback for simple date strings like YYYY-MM-DD
